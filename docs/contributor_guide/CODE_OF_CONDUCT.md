# Code of conduct for `first_repo`

Contributors to this repository hosted by `joshlynchONS` are expected to follow the
...
- "Project", we mean this `first_repo` GitHub repository;
- "Maintainer", we mean the `joshlynchONS` organisation owners; and
- "Leadership", we mean both `joshlynchONS` organisation owners, line managers, and other
...
[joshua.lynch@ext.ons.gov.uk][email-address]. All complaints will be
...
[email-address]: mailto:joshua.lynch@ext.ons.gov.uk
